...
- `presentation/steppe_modernism/output/pdf/Market_Launch_Research_v16_2026-09-17.pdf` — итоговая клиентская презентация с кликабельными ссылками.
...
AVDAR_SLIDES_DIR="$PWD/output/v16_slides" \
AVDAR_LINK_MAP_PATH="$PWD/output/v16_links.json" \
node scripts/render.mjs

AVDAR_SLIDES_DIR="$PWD/output/v16_slides" \
AVDAR_LINK_MAP_PATH="$PWD/output/v16_links.json" \
python3 scripts/assemble_pdf.py "$PWD/output/pdf/Market_Launch_Research_v16_2026-09-17.pdf"
```
